...
```
cd existing_repo
git remote add origin https://gitlab.com/dax_mesapp_g16/g16_holstein.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/dax_mesapp_g16/g16_holstein/-/settings/integrations)
